...
(function () {
  ...
  function legalModal() {
    ...
    openModal('📜 Правила, конфиденциальность и отказ от ответственности', `
      ...
      <p style="color:#6b7280;font-size:11px;margin-top:14px">Документ носит информационный характер и не заменяет юридическую консультацию. Редакция от текущей даты.</p>`);
  }
