 ...
 * ⚠ Солнце–Меркурий расходятся максимум на ~28°, поэтому у этой пары бывает
 * только СОЕДИНЕНИЕ; для полного набора аспектов бери пары с Луной/внешними. */
LUN.ASPECTS = { enabled: false, bodyA: 'Sun', bodyB: 'Mercury', orb: 3 };
