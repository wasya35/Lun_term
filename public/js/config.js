...
// arrowMin/circleMin — пороги маркеров «Физ/Юр на свечах» по РАЗМЕРУ ПОЗИЦИИ
// (контракты за бар): стрелки счетов от arrowMin, кружки бид/аск («ФАС») от circleMin.
// Фильтр по контрактам (а не по лицам), чтобы юрики (мало лиц, крупные объёмы) не пропадали.
LUN.FUTOI = { threshold: 100, arrowMin: 500, circleMin: 4000 };
