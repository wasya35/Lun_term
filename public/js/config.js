...
// marks — полная палитра порогов маркеров «Физ/Юр на свечах» по РАЗМЕРУ ПОЗИЦИИ
// (контракты за бар): {физ|юр}×{стрелки счета|кружки бид/аск}×{открытие|закрытие}.
// Меньше порога — маркер не рисуется. Фильтр по контрактам (а не по лицам), чтобы
// юрики (мало лиц, крупные объёмы) не пропадали. Настраивается в меню МОЕКС.
LUN.FUTOI = { threshold: 100, marks: {
  fizArrOpen: 500,  fizArrClose: 500,  fizCircOpen: 4000,  fizCircClose: 4000,
  yurArrOpen: 500,  yurArrClose: 500,  yurCircOpen: 4000,  yurCircClose: 4000,
} };
