 ...
 * 15° Козерога = 285°.
 *
 * ЦИКЛ 1 — исследуемая лунная гипотеза (черновик, правь под себя).
 * ЦИКЛЫ 2–6 — пустые заготовки: включи, впиши зоны и/или смени body. */
LUN.CYCLES = [
  {
  ...
  { id: 'cycle3', title: 'Цикл 3', body: 'Moon', enabled: false, zones: [] },
  { id: 'cycle4', title: 'Цикл 4', body: 'Moon', enabled: false, zones: [] },
  { id: 'cycle5', title: 'Цикл 5', body: 'Moon', enabled: false, zones: [] },
  { id: 'cycle6', title: 'Цикл 6', body: 'Moon', enabled: false, zones: [] },
];
